    ...
    nWeight(0)
{
...
#endif
    setObjectName("neoscoin");
    setStyleSheet("#neoscoin { background-color: qradialgradient(cx: -0.8, cy: 0, fx: -0.8, fy: 0, radius: 1.4, stop: 0 #dedede, stop: 1 #efefef);  }");
    // Accept D&D of URIs
    setAcceptDrops(true);
    ...
    bittrexDialogPage = new bittrexDialog(this);
    bittrexDialogPage->setObjectName("bittrexDialog");
    ...
    centralStackedWidget->addWidget(bittrexDialogPage);
    ...
    connect(bittrexAction, SIGNAL(triggered()), bittrexDialogPage, SLOT(InitBittrex()));
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a NeosCoin address"));
    ...
    bittrexAction = new QAction(QIcon(":/icons/trade"), tr("&Bittrex"), this);
    bittrexAction ->setToolTip(tr("Start Trading"));
    bittrexAction ->setCheckable(true);
    bittrexAction ->setShortcut(QKeySequence(Qt::ALT + Qt::Key_8));
    bittrexAction->setProperty("objectName","bittrexAction");
    ...
    aboutAction = new QAction(tr("&About NeosCoin"), this);
    aboutAction->setToolTip(tr("Show information about NeosCoin"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for NeosCoin"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("NeosCoin client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::setWalletModel(WalletModel *walletModel)
{
    ...
    if(walletModel)
    {
        ...
        bittrexDialogPage->setModel(walletModel);
...
void BitcoinGUI::gotoBittrexPage()
{
     ...
     centralStackedWidget->setCurrentWidget(bittrexDialogPage);
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid NeosCoin address or malformed URI parameters."));
    }
