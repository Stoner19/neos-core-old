...
bittrexDialog::bittrexDialog(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::bittrexDialog),
    model(0)
{
    ui->setupUi(this);
    timerid = 0;
    ...
    ui->bittrexTabWidget->setTabEnabled(0,false);
    ui->bittrexTabWidget->setTabEnabled(1,false);
    ui->bittrexTabWidget->setTabEnabled(3,false);
    ui->bittrexTabWidget->setTabEnabled(4,false);
    ui->bittrexTabWidget->setTabEnabled(5,false);
    ...
    ui->MarketHistoryTable->setHorizontalHeaderLabels(QStringList()<<"DATE"<<"BUY/SELL"<<"BID/ASK"<<"TOTAL UNITS(NEOS)"<<"TOTAL COST(BTC)");
...
void bittrexDialog::InitBittrex()
...
void bittrexDialog::UpdaterFunction(){
...
QString bittrexDialog::GetMarketSummary(){

     QString Response = sendRequest("https://bittrex.com/api/v1.1/public/GetMarketSummary?market=btc-NEOS");
     return Response;
}

QString bittrexDialog::GetOrderBook(){

      QString  Response = sendRequest("https://bittrex.com/api/v1.1/public/getorderbook?market=BTC-NEOS&type=both&depth=50");
      return Response;
}

QString bittrexDialog::GetMarketHistory(){
      QString Response = sendRequest("https://bittrex.com/api/v1.1/public/getmarkethistory?market=BTC-NEOS&count=100");
      return Response;
}

QString bittrexDialog::CancelOrder(QString OrderId){
...
QString bittrexDialog::BuyTX(QString OrderType, double Quantity, double Rate){
    ...
    QString URL = "https://bittrex.com/api/v1.1/market/";
            ...
            URL += "?apikey=";
            URL += this->ApiKey;
            URL += "&nonce=12345434&market=BTC-NEOS&quantity=";
...
QString bittrexDialog::SellTX(QString OrderType, double Quantity, double Rate){
...
QString bittrexDialog::Withdraw(double Amount, QString Address, QString Coin){
...
QString bittrexDialog::GetOpenOrders(){
    QString URL = "https://bittrex.com/api/v1.1/market/getopenorders?apikey=";
            URL += this->ApiKey;
            URL += "&nonce=12345434&market=BTC-NEOS";

    QString Response = sendRequest(URL);
    return Response;
}

QString bittrexDialog::GetBalance(QString Currency){
...
QString bittrexDialog::GetDepositAddress(){

    QString URL = "https://bittrex.com/api/v1.1/account/getdepositaddress?apikey=";
            URL += this->ApiKey;
            URL += "&nonce=12345434&currency=NEOS";

    QString Response = sendRequest(URL);
    return Response;
}

QString bittrexDialog::GetAccountHistory(){

    QString URL = "https://bittrex.com/api/v1.1/account/getorderhistory?apikey=";
            URL += this->ApiKey;
            URL += "&nonce=12345434&market=BTC-NEOS&count=10";

    QString Response = sendRequest(URL);
    return Response;
}

int bittrexDialog::SetExchangeInfoTextLabels(){
    ...
    ui->volumet->setText("<b>NEOS Volume:</b> <span style='font-weight:bold; font-size:12px; color:blue;'>" + str.number(obj["Volume"].toDouble(),'i',8) + "</span> NEOS");
...
void bittrexDialog::CreateOrderBookTables(QTableWidget& Table,QStringList TableHeader){
...
void bittrexDialog::DisplayBalance(QLabel &BalanceLabel,QLabel &Available, QLabel &Pending, QString Currency,QString Response){
...
void bittrexDialog::DisplayBalance(QLabel &BalanceLabel, QString Response){
...
void bittrexDialog::DisplayBalance(QLabel &BalanceLabel, QLabel &BalanceLabel2, QString Response, QString Response2){
...
void bittrexDialog::ParseAndPopulateOpenOrdersTable(QString Response){
...
void bittrexDialog::CancelOrderSlot(int row, int col){
...
void bittrexDialog::ParseAndPopulateAccountHistoryTable(QString Response){
...
void bittrexDialog::ParseAndPopulateOrderBookTables(QString OrderBook){
    ...
    ui->TXSupply->setText("<b>Supply:</b> <span style='font-weight:bold; font-size:12px; color:blue'>" + str.number(TXSupply,'i',8) + "</span><b> NEOS</b>");
    ...
    ui->TXDemand->setText("<b>Demand:</b> <span style='font-weight:bold; font-size:12px; color:blue'>" + str.number(TXDemand,'i',8) + "</span><b> NEOS</b>");
...
void bittrexDialog::ParseAndPopulateMarketHistoryTable(QString Response){
...
void bittrexDialog::ActionsOnSwitch(int index = -1){
    ...
    if(index == -1){
       index = ui->bittrexTabWidget->currentIndex();
    }
    ...
    switch (index){
                ...
                case 5://show balance tab
                    ...
                    Response = GetBalance("NEOS");
                    if(Response.size() > 0 && Response != "Error"){
                        DisplayBalance(*ui->TXBalanceLabel,*ui->TXAvailableLabel_2,*ui->TXPendingLabel, QString::fromUtf8("NEOS"),Response);
                    }
                break;
...
void bittrexDialog::on_bittrexTabWidget_tabBarClicked(int index)
{
...
QString bittrexDialog::sendRequest(QString url){
...
QString bittrexDialog::BittrexTimeStampToReadable(QString DateTime){
...
void bittrexDialog::CalculateBuyCostLabel(){
...
void bittrexDialog::CalculateSellCostLabel(){
...
void bittrexDialog::CalculateCSReceiveLabel(){

    //calculate amount of currency than can be neoscoinred to bitcoin
    QString balance = GetBalance("NEOS");
...
void bittrexDialog::on_UpdateKeys_clicked(bool Save, bool Load)
{
  ...
  if ( ResponseObject.value("success").toBool() == false){
       QMessageBox::information(this,"API Configuration Failed","Api configuration was unsuccesful.");
         ...
         ui->bittrexTabWidget->setTabEnabled(0,true);
         ui->bittrexTabWidget->setTabEnabled(1,true);
         ui->bittrexTabWidget->setTabEnabled(3,true);
         ui->bittrexTabWidget->setTabEnabled(4,true);
         ui->bittrexTabWidget->setTabEnabled(5,true);
...
string bittrexDialog::encryptDecrypt(string toEncrypt, string password) {
...
void bittrexDialog::on_SaveKeys_clicked()
{
    bool fSuccess = true;
...
void bittrexDialog::on_LoadKeys_clicked()
{
    bool fSuccess = true;
    boost::filesystem::path pathConfigFile = GetDataDir() / "APIcache.txt";
...
void bittrexDialog::on_GenDepositBTN_clicked()
{
...
void bittrexDialog::on_Sell_Max_Amount_clicked()
{
    //calculate amount of BTC that can be gained from selling TX available balance
    QString responseA = GetBalance("NEOS");
    QString str;
...
void bittrexDialog::on_Buy_Max_Amount_clicked()
{
...
void bittrexDialog::on_CS_Max_Amount_clicked()
{
...
void bittrexDialog::on_Withdraw_Max_Amount_clicked()
{
    //calculate amount of currency than can be brought with the BTC balance available
    QString responseA = GetBalance("NEOS");
    QString str;
...
QJsonObject bittrexDialog::GetResultObjectFromJSONObject(QString response){
...
QJsonObject bittrexDialog::GetResultObjectFromJSONArray(QString response){
...
QJsonArray bittrexDialog::GetResultArrayFromJSONObject(QString response){
...
QString bittrexDialog::HMAC_SHA512_SIGNER(QString UrlToSign, QString Secret){
...
void bittrexDialog::on_SellBidcomboBox_currentIndexChanged(const QString &arg1)
{
    QString response = GetMarketSummary();
...
void bittrexDialog::on_BuyBidcomboBox_currentIndexChanged(const QString &arg1)
{
    QString response = GetMarketSummary();
    QJsonObject ResultObject = GetResultObjectFromJSONArray(response);
    QString Str;
...
void bittrexDialog::on_BuyTX_clicked()
{
    double Rate;
    double Quantity;
...
void bittrexDialog::on_SellTXBTN_clicked()
{
    double Rate;
    double Quantity;
...
void bittrexDialog::on_CSUnitsBtn_clicked()
{
    double Quantity = ui->CSUnitsInput->text().toDouble();
                ...
                if (SellResponseObject["success"].toBool() == false){
                    ...
                    if (ResponseObject["success"].toBool() == false){
                        ...
                        if (ResponseObject["success"].toBool() == false){
                            ...
                            QMessageBox::information(this,"Success","<center>Cross-Send Successful</center>\n Sold "+Astr.number(Qty,'i',4)+" NEOS for "+Qstr.number((ui->CSUnitsInput->text().toDouble()-0.0002),'i',8)+" BTC");
                        }
                    } else if (ResponseObject["success"].toBool() == true){
                        QMessageBox::information(this,"Success","<center>Cross-Send Successful</center>\n Sold "+Astr.number(Qty,'i',4)+" NEOS for "+Qstr.number((ui->CSUnitsInput->text().toDouble()-0.0002),'i',8)+" BTC");
                    }
...
void bittrexDialog::on_WithdrawUnitsBtn_clicked()
{
...
void bittrexDialog::on_UnitsInputTX_textChanged(const QString &arg1)
{
     CalculateSellCostLabel(); //update cost
}

void bittrexDialog::on_UnitsInput_textChanged(const QString &arg1)
{
     CalculateBuyCostLabel(); //update cost
}

void bittrexDialog::on_BuyBidPriceEdit_textChanged(const QString &arg1)
{
     CalculateBuyCostLabel(); //update cost
}

void bittrexDialog::on_SellBidPriceEdit_textChanged(const QString &arg1)
{
     CalculateSellCostLabel();
}

void bittrexDialog::on_CSUnitsInput_textChanged(const QString &arg1)
{
    CalculateCSReceiveLabel(); //update cost
}

void bittrexDialog::on_CSPasteButton_clicked()
{
    // Paste text from clipboard into recipient field
    ui->CSUnitsAddress->setText(QApplication::clipboard()->text());
}

void bittrexDialog::on_WithdrawPasteButton_clicked()
{
    // Paste text from clipboard into recipient field
    ui->WithdrawAddress->setText(QApplication::clipboard()->text());
}

void bittrexDialog::on_SecretPasteButton_clicked()
{
    // Paste text from clipboard into recipient field
    ui->SecretKeyInput->setText(QApplication::clipboard()->text());
}

void bittrexDialog::on_KeyPasteButton_clicked()
{
    // Paste text from clipboard into recipient field
    ui->ApiKeyInput->setText(QApplication::clipboard()->text());
}

void BittrexsetClipboard(const QString& str)
{
    QApplication::clipboard()->setText(str, QClipboard::Clipboard);
    QApplication::clipboard()->setText(str, QClipboard::Selection);
}

void bittrexDialog::on_DepositCopyButton_clicked()
{
    BittrexsetClipboard(ui->DepositAddressLabel->text());
}

void bittrexDialog::setModel(WalletModel *model)
{
    this->model = model;
}

bittrexDialog::~bittrexDialog()
{
    delete ui;
}
