...
#ifndef BITTREXDIALOG_H
#define BITTREXDIALOG_H
...
class bittrexDialog : public QDialog
{
    Q_OBJECT

public:
    explicit bittrexDialog(QWidget *parent = 0);
    ~bittrexDialog();
...
private slots:
    ...
    void InitBittrex();
    void on_bittrexTabWidget_tabBarClicked(int index);
